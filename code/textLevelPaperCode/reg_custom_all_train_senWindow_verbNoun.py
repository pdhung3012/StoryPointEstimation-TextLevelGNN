...
if __name__ == '__main__':
    ...
    fopDataset = '../../../../dataPapers/dataTextLevelPaper/a_regressionSEE/'
    fopCsv = '../../dataset/'
    # fpResultSEE = fopDataset + "/resultSEE.txt"
    fonResult = 'resultSEE_senWindow_verbNoun/'
    ...
    for win in arrWindow:
        ...
        for filename in list_dir:
            ...
            try:
                ...
                maeAccuracy = mean_absolute_error(lLabel, lPred)
                mqeAccuracy = mean_squared_error(lLabel, lPred)
                y_test = lLabel
                predicted = lPred
                ...
                print('{}\t{:.2f}'.format(fnSystem, maeAccuracy))
